  ...
  return (
    <div>
      ...
      <textarea
        ...
        rows={8}
        dir="ltr"
        className={`w-full rounded-lg border bg-background-light px-3 py-2 text-sm font-mono text-navy outline-none transition-colors resize-y ${
          jsonError ? 'border-red-300 focus:border-red-400' : 'border-slate-200 focus:border-ocean'
        }`}
