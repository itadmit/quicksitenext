...
export default function QuoteBlockEditor({ data, onChange }: Props) {
  ...
  return (
    <div className="space-y-4">
      <div>
        <label className="mb-1.5 block text-[10px] font-bold uppercase tracking-widest text-navy/60">ציטוט</label>
        <textarea
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="mb-1.5 block text-[10px] font-bold uppercase tracking-widest text-navy/60">שם המצטט</label>
          <input
        ...
        <div>
          <label className="mb-1.5 block text-[10px] font-bold uppercase tracking-widest text-navy/60">תפקיד</label>
          <input
