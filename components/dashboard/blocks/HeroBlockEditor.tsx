  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="col-span-2">
          <label className="mb-1.5 block text-[10px] font-bold uppercase tracking-widest text-charcoal/60">תת כותרת</label>
          <input
        ...
        <div className="col-span-2">
          <label className="mb-1.5 block text-[10px] font-bold uppercase tracking-widest text-charcoal/60">תמונת רקע (URL)</label>
          <input
        ...
        <div>
          <label className="mb-1.5 block text-[10px] font-bold uppercase tracking-widest text-charcoal/60">כפתור ראשי - טקסט</label>
          <input
        ...
        <div>
          <label className="mb-1.5 block text-[10px] font-bold uppercase tracking-widest text-charcoal/60">כפתור ראשי - קישור</label>
          <input
        ...
        <div>
          <label className="mb-1.5 block text-[10px] font-bold uppercase tracking-widest text-charcoal/60">כפתור משני - טקסט</label>
          <input
        ...
        <div>
          <label className="mb-1.5 block text-[10px] font-bold uppercase tracking-widest text-charcoal/60">כפתור משני - קישור</label>
          <input
