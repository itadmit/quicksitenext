...
export default function PostsGridBlockEditor({ data, onChange }: Props) {
  return (
    <div className="grid grid-cols-2 gap-4">
      <div>
        <label className="mb-1.5 block text-[10px] font-bold uppercase tracking-widest text-navy/60">מספר פוסטים</label>
        <input
          type="number"
          min={1}
          max={50}
      ...
      <div>
        <label className="mb-1.5 block text-[10px] font-bold uppercase tracking-widest text-navy/60">עמודות</label>
        <select
