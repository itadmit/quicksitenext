  ...
  return (
    <div className="flex items-center gap-4">
      <div className="flex-1">
        <label className="mb-1.5 block text-[10px] font-bold uppercase tracking-widest text-navy/60">גובה (px)</label>
        <input
          type="number"
          min={0}
          max={500}
      ...
      <div
        className="rounded-2xl border border-dashed border-slate-200 bg-slate-50 flex-1 flex items-center justify-center text-[10px] text-slate-400 uppercase tracking-widest"
