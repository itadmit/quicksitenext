...
export default function TenantFooter({ siteName, footerText, socialLinks, menuItems }: Props) {
      ...
      <div className="mx-auto max-w-7xl px-4 py-12">
        <div className="grid gap-10 md:grid-cols-3">
          ...
          <div>
            ...
            {footerText && (
              <p className="mt-3 text-sm leading-relaxed text-white/70">{footerText}</p>
            )}
          </div>
                ...
                {socials.map((s, i) => (
                  ...
                  >
                    <svg
                      ...
                      aria-hidden="true"
                    >
                      <path d={SOCIAL_ICONS[s.platform.toLowerCase()] || SOCIAL_ICONS.facebook} />
                    </svg>
                  </a>
                ))}
              </div>
